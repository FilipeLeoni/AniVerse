...
export default function EpisodeEdit({ params }: { params: any }) {
  console.log(params);
  ...
  const { mutate: editEpisode } = useEditEpisode();
  const api = useApi();
  const { data } = useQuery({
  ...
  return (
    <div className="overflow-y-auto">
      ...
      <Section className="py-3 flex justify-end gap-2 items-center fixed bottom-0 w-full md:w-[80%] bg-background-800 -ml-3 right-0">
